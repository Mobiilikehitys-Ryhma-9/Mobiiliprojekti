# :earth_americas: Kartta-sovellus

Sovellus on tarkoitettu edistämään esteetööntä liikkumista kaupunkiympäristössä. Karttanäkymässä esitetään reittivaihtoehtoja kävelevälle tai pyörätuolilla liikkuvalle käyttäjälle. Rekisteröidyt käyttäjät pystyvät ilmoittamaan mahdollisia esteettömyyteen liittyviä huomioita, jotka huomioidaan reittivaihtoehdoissa. Sovellus on toteutettu React Nativella sekä reittivaihtoehtojen hakemiseen sovellus käyttää [OpenRouteService](https://openrouteservice.org/) rajapintaa. Käyttäjien tehdyt ilmoitukset tallentuvat Googlen Firebase Firestoreen. 
...
Käyttäjä voi kirjautumatta sovellukseen hakea eri reittivaihtoehtoja. Käyttäjä voi valita reitiksi joko kävelyä tai pyörätuolia suosivan reitin. Pyörätuolilla kulkevan reittivalinassa kartta ottaa huomioon eri maanpinnan korkeuden muutokset.
